   ...
   groups = {
    ...
    pets = {
     ...
     ["Ai-Li's Skymirror"] =                             { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(86589) or L["Ai-Li's Skymirror"], itemId = 86589, npcs = { 50821, }, chance = 7, sourceText = L[""], coords = { {m=858,x=34.8,y=23.2} }, },
					["Aqua Jewel"] =                                    { cat = MOP, type = TOY, isToy = true, method = NPC, name = GetItemInfo(86582) or L["Aqua Jewel"], itemId = 86582, npcs = { 50780, }, chance = 10, sourceText = L[""], coords = { {m=811,x=69.6,y=30.8,n=L["Sahn Tidehunter"]} }},
     ...
     ["Blackflame Daggers"] =                            { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(104302) or L["Blackflame Daggers"], itemId = 104302, npcs = { 73171, }, chance = 100, sourceText = L[""], coords = { {m=951,x=63.6,y=43.6} }, },
					["Bottled Tornado"] =                               { cat = MOP, type = TOY, isToy = true, method = NPC, name = GetItemInfo(134023) or L["Bottled Tornado"], itemId = 134023, npcs = { 50749, }, chance = 5, sourceText = L[""], coords = { {m=811,x=14,y=58.6,n=L["Kal'tik the Blight"]} }},
					["Chain Pet Leash"] =                               { cat = MOP, type = ITEM, isToy = true, method = USE, name = GetItemInfo(89139) or L["Chain Pet Leash"], itemId = 89139, items = { 89125, 93148, 93147, 93146, 93149, 94207, 91086, 116062, 98095 }, chance = 2, sourceText = L[""], },
     ["Chalice of Secrets"] =                            { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(86575) or L["Chalice of Secrets"], itemId = 86575, npcs = { 50359, }, chance = 5, sourceText = L[""], coords = { {m=811,x=39.8,y=25} }, },
					["Essence of the Breeze"] =                         { cat = MOP, type = TOY, isToy = true, method = NPC, name = GetItemInfo(86590) or L["Essence of the Breeze"], itemId = 86590, npcs = { 50822, }, chance = 5, sourceText = L[""], coords = { {m=811,x=42.6,y=69.0,n=L["Ai-Ran the Shifting Cloud"]} }},
     ["Eternal Kiln"] =                                  { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(104309) or L["Eternal Kiln"], itemId = 104309, npcs = { 72896, }, chance = 250, sourceText = L[""], coords = { {m=951,x=68.6,y=35.2} }, },
					["Eternal Warrior's Sigil"] =                       { cat = MOP, type = TOY, isToy = true, method = NPC, name = GetItemInfo(86578) or L["Eternal Warrior's Sigil"], itemId = 86578, npcs = { 50739, }, chance = 7, sourceText = L[""], coords = { {m=858,x=35.6,y=30.8,n=L["Gar'lok"]},{m=858,x=37.8,y=29.6,n=L["Gar'lok"]},{m=858,x=39.2,y=41.8,n=L["Gar'lok"]} }},
     ...
     ["Gastropod Shell"] =                               { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(98136) or L["Gastropod Shell"], itemId = 98136, npcs = { 68220, }, chance = 150, sourceText = L[""], coords = { {m=930,f=3,x=44.4,y=80.4,i=true} }, },
					["Hardened Shell"] =                                { cat = MOP, type = TOY, isToy = true, method = NPC, name = GetItemInfo(86584) or L["Hardened Shell"], itemId = 86584, npcs = { 50789, }, chance = 6, sourceText = L[""], coords = { {m=809,x=63.8,y=13.8,n=L["Nessos the Oracle"]} }}, -- Chelon and Great Turtle Furyshell drop the shell too with a 1.7% chance
					["Helpful Wikky's Whistle"] =                       { cat = MOP, type = TOY, isToy = true, method = NPC, name = GetItemInfo(86594) or L["Helpful Wikky's Whistle"], itemId = 86594, npcs = { 50840, }, chance = 5, sourceText = L[""], coords = { {m=811,x=31,y=91.6,n=L["Major Nanners"]} }},
     ...
     ["Rime of the Time-Lost Mariner"] =                 { cat = MOP, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(104294) or L["Rime of the Time-Lost Mariner"], itemId = 104294, npcs = { 73281, }, chance = 7, sourceText = L[""], coords = { {m=951,x=25.8,y=23.2} }, },
					["Salyin Battle Banner"] =                          { cat = MOP, type = TOY, isToy = true, method = NPC, name = GetItemInfo(86583) or L["Salyin Battle Banner"], itemId = 86583, npcs = { 50783, }, chance = 7, sourceText = L[""], coords = { {m=807,x=67.6,y=60,n=L["Salyin Warscout"]},{m=807,x=71,y=52.4,n=L["Salyin Warscout"]},{m=807,x=75.8,y=46.4,n=L["Salyin Warscout"]} }},
     ...
     ["Fandral's Seed Pouch"] =                          { cat = WOD, type = ITEM, isToy = true, method = NPC, name = GetItemInfo(122304) or L["Fandral's Seed Pouch"], itemId = 122304, npcs = { 52571, }, chance = 100, sourceText = L["Will only drop for druids."], coords = { {m=800,f=2,x=50.9,y=72.4,i=true} }, },
					["Goren \"Log\" Roller"] =                          { cat = WOD, type = TOY, isToy = true, method = NPC, name = GetItemInfo(119180) or L["Goren \"Log\" Roller"], itemId = 119180, npcs = { 87352, }, chance = 7, sourceText = L[""], questId = 37380, coords = { {m=941,x=66.6,y=25.4,n=L["Gibblette the Cowardly"]} }},
					["Sassy Imp"] =                                     { cat = WOD, type = TOY, isToy = true, method = NPC, name = GetItemInfo(127655) or L["Sassy Imp"], itemId = 127655, npcs = { 90429, }, chance = 3, sourceText = L[""], questId = 38026, coords = { {m=945,x=31.6,y=72.8,n=L["Imp-Master Valessa"]} }},
