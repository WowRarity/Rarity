...
function R:PrepareDefaults()
   ...
   groups = {
    ...
    pets = {
     ...
     ["Droplet of Y'Shaarj"] =                           { cat = MOP, type = PET, method = BOSS, name = GetItemInfo(104162) or L["Droplet of Y'Shaarj"], spellId = 148058, itemId = 104162, npcs = { 99999 }, chance = 16, groupSize = 10, statisticId = { 8571, 5869, 8573, 8570, 8568, }, creatureId = 73350, enableCoin = true, }, -- SHA OF PRIDE (flex/normal/heroic)
     ["Gooey Sha-ling"] =                                { cat = MOP, type = PET, method = BOSS, name = GetItemInfo(104163) or L["Gooey Sha-ling"], spellId = 148059, itemId = 104163, npcs = { 99999 }, chance = 33, groupSize = 25, equalOdds = true, statisticId = { 8568, 8567, }, creatureId = 73351, enableCoin = true, }, -- SHA OF PRIDE (lfr/flex)
