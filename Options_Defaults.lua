...
function R:PrepareDefaults()
   ...
   groups = {
    ...
    ["Living Infernal Core"] =                          { cat = LEGION, type = MOUNT, method = BOSS, name = L["Living Infernal Core"], spellId = 213134, itemId = 137574, npcs = { 99999 }, tooltipNpcs = { 105503 }, chance = 100, groupSize = 10, equalOdds = true, statisticId = { 10979, 10980, 10978 }, coords = { {m=772,f=9,i=true} }, },
