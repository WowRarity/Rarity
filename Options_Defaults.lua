...
function R:PrepareDefaults()
   ...
   groups = {
    ...
    pets = {
	 ...
	 ["Stormforged Rune"] =								 { cat = LEGION, type = PET, method = NPC, name = L["Stormforged Rune"], itemId = 142088, spellId = 229095, creatureId = 115140, npcs = { 99999 }, chance = 10,  coords = {{m=148,x=15.5,y=55.9,i=true}},},
