...
RarityBarContainer.dummyFrame = RarityBarContainer.dummyFrame or
    CreateFrame("Frame")
RarityBarContainer.barFrameMT = RarityBarContainer.barFrameMT or
    {
        __index = RarityBarContainer.dummyFrame
    }
RarityBarContainer.barPrototype = RarityBarContainer.barPrototype or
    setmetatable({}, RarityBarContainer.barFrameMT)
RarityBarContainer.barPrototype_mt = RarityBarContainer.barPrototype_mt or
    {
        __index = RarityBarContainer.barPrototype
    }
RarityBarContainer.barListPrototype = RarityBarContainer.barListPrototype or
    setmetatable({}, RarityBarContainer.barFrameMT)
RarityBarContainer.barListPrototype_mt = RarityBarContainer.barListPrototype_mt or
    {
