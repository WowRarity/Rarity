...
L["Hopecrusher"] = true
L["Sometimes contained in the caches awarded for completing any covenant's Calling in Maldraxxus. Will hatch into one of three Necroray mounts after three days."] = true
L["Necroray Egg"] = true
...
L["On hover"] = true
L["On click"] = true
L["If \"On click\" is selected, toggling the tracker is done with Right click, otherwise it's activated with a simple click."] = true
