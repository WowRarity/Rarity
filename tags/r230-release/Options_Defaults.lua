...
function R:PrepareDefaults()
   ...
   groups = {
    ...
    pets = {
     ...
     ["Pygmy Direhorn"] =                                { cat = MOP, type = PET, method = BOSS, name = GetItemInfo(94574) or L["Pygmy Direhorn"], spellId = 138825, itemId = 94574, npcs = { 99999 }, chance = 50, groupSize = 10, statisticId = { 8152 }, creatureId = 70083, enableCoin = true, },
