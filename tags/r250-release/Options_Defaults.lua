...
function R:PrepareDefaults()
   ...
   groups = {
    ...
    mounts = {
     ...
     -- Note to self: change Primordial Direhorns to LOOT detection instead of BOSS when moving them to soloable. Also check any out-in-the-world mobs and do the same.
